...
# Camera Placement (Options: "front", "top-right", "top-left", "dashboard")
CAMERA_POSITION = "top-right"  # Change this to test different placements
# Thresholds
FPS = 12
...
while cap.isOpened():
    ...
    for result in results:
        for box in result.boxes:
            ...
            if class_id == 0:  # Face detected
                ...
                # Set initial face position for center reference
    ...
    if face_center:
        ...
        if CAMERA_POSITION == "top-right":
            ...
            if delta_x > MOVE_THRESHOLD:
                ...
                face_position = "Looking Up"
        elif CAMERA_POSITION == "dashboard":
            if delta_x > MOVE_THRESHOLD:
                face_position = "Looking Right"
            elif delta_x < -MOVE_THRESHOLD:
                face_position = "Looking Left"
    ...
    if face_position in ["Looking Left", "Looking Right"]:
        cv2.putText(annotated_frame, "WARNING! Driver Looking Sideways", (50, 100),
                    cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0, 255, 255), 3)
        print(f"ALERT: {face_position}")
    if face_position in ["Looking Up", "Looking Down"]:
        cv2.putText(annotated_frame, "WARNING! Face Position Abnormal", (50, 100),
